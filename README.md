...
I’m an MSc Computer Science & Business Technology graduate with a hybrid profile spanning **AI engineering**, **ML systems**, **data science**, and **software engineering**. I build practical solutions that blend cutting-edge generative AI with robust software architecture, ranging from multi-agent orchestration platforms to scalable ML pipelines.

I’ve contributed to systems, such as a **multi-agent risk classifier at BHSI** that cut underwriting reviews from hours to minutes, and prototyped autonomous research and trading systems across diverse LLMs and cloud platforms.
...
I recently contributed to an **enterprise underwriting risk classification system at BHSI**, where a multi-agent platform automated financial risk analysis and reduced underwriting review time **from hours to minutes**.

My current focus is building **AI systems that bridge research prototypes and production software**, including async agent orchestration, evaluation loops, and reproducible ML pipelines.
...
🧰 *Python · OpenAI Agents SDK · asyncio · Gradio*

Built a **multi-agent research pipeline implementing five agent orchestration patterns** including routing, parallelisation, and evaluator-optimiser loops.
...
Developed an **autonomous trading analysis system** coordinating multiple LLM agents responsible for research, signal analysis, and portfolio evaluation.
...
Implemented a **reproducible MLOps pipeline** for hospital readmission prediction using experiment tracking, configuration management, and model evaluation workflows.
...
**LangGraph Autonomous Task Agent**
Autonomous task execution system using LangGraph with browser automation, RAG memory, and tool-based workflows.

**Multi-Model Sales Agent System**
Persona-driven agent orchestration platform generating segmented outreach campaigns across multiple LLM providers.
...
**Innovation Intern — United Utilities (UK)**
Improved documentation and internal processes supporting engineering teams and operational efficiency initiatives.

**Financial Advisory Intern — Hargreaves Lansdown (UK)**
Streamlined advisory workflows and delivered analytical insights supporting financial planning and client strategy.
...
IE School of Science and Technology — Madrid
...
LinkedIn: [https://www.linkedin.com/in/cameronsobell/](https://www.linkedin.com/in/cameronsobell/)
